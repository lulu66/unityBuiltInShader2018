...
//USING_LIGHT_MULTI_COMPILE：？？？
//分为平行光和非平行光，非平行光：光源位置 - 顶点位置
...
//计算物理空间的光照方向：v是物理空间的顶点位置，需要将灯光位置转到物理空间，然后按照非平行光和平行光分开计算光照方向
...
//在forwardBase pass使用：计算4个点光源的diffuse光照，4盏点光源以特别的方式存储
...
//unity_LightPosition[i]是视图空间中的光源位置
//计算给定数量灯光的diffuse颜色（点光源或spot光源）
